...
export async function generateMetadata(): Promise<Metadata> {
	const launchT = await getTranslations({ locale: "en" });
...
export default async function LaunchPageEN(): Promise<JSX.Element> {
	const launchT = await getTranslations({ locale: "en" });
	const { translate, raw } = createLaunchHelpers(launchT);

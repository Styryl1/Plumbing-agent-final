...
const schema = z.object({
	...
	BUCKET_INVOICE_EXPORTS: z.string().default("invoice-exports"),
...
const parsed = schema.safeParse({
	...
	BUCKET_INVOICE_EXPORTS: process.env.BUCKET_INVOICE_EXPORTS,
...
export const serverOnlyEnv = (() => {
	...
	return {
		...
		BUCKET_INVOICE_EXPORTS: env.BUCKET_INVOICE_EXPORTS,
